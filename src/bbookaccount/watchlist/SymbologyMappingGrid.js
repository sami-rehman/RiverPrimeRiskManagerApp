...
const SymbologyMappingGrid = () => {
    ...
    const rowData = [
        ...
        // Pricing and Markup
        { attribute: "Markup", cmc: "0.3 pips", lmax: "0.1 pips", matchPrime: "0.15 pips", mt: "0.2 pips" },
        { attribute: "Spreads", cmc: "0.00024", lmax: "0.0029", matchPrime: "0.00018", mt: "0.00011" },
        
        // Costs
        { attribute: "Fees", cmc: "$3 per lot", lmax: "$2.5 per lot", matchPrime: "$2.8 per lot", mt: "$3 per lot" },
        { attribute: "Commissions", cmc: "$5 per million", lmax: "$4.5 per million", matchPrime: "$4.75 per million", mt: "$5 per million" },
        
        // Margin Requirements
        { attribute: "Init. Margins", cmc: "1.5%", lmax: "2.0%", matchPrime: "1.8%", mt: "2.0%" },
        { attribute: "Main. Margins", cmc: "0.75%", lmax: "1.0%", matchPrime: "0.9%", mt: "1.0%" },
        
        // Leverage
        { attribute: "Leverage", cmc: "1:200", lmax: "1:100", matchPrime: "1:150", mt: "1:100" },
        
        // Order Types
        { attribute: "OT: Limit", cmc: "Supported", lmax: "Not supported", matchPrime: "Supported", mt: "Supported" },
        { attribute: "OT: Stop", cmc: "Supported", lmax: "Supported", matchPrime: "Not supported", mt: "Supported" },
        ...
        { attribute: "Max. Size", cmc: "500 lots", lmax: "100 lots", matchPrime: "200 lots", mt: "500 lots" },
