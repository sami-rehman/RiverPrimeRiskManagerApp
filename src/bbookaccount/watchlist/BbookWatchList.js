...
const BbookWatchList = () => {
  ...
  const colDefs = useMemo(() => [
    ...
    { headerName: "MT Submit", field: "activationTime", filter: "agDateColumnFilter", filterFramework: CustomDateFilter, minWidth: 185, rowDrag: true, floatingFilter: false },
    { headerName: "MT Execution", field: "activationTime", filter: "agDateColumnFilter", filterFramework: CustomDateFilter, minWidth: 185, floatingFilter: false },
      ...
      <div className="flex items-center space-x-4 m-1">
        ...
        <div className="w-60">
          <Datepicker
            ...
            inputClassName={'relative transition-all duration-300 py-1 pl-4 pr-14 w-full border-gray-600 dark:bg-gray-500 dark:text-white dark:border-gray-600 rounded tracking-wide text-xs placeholder-gray-400 bg-white focus:ring disabled:opacity-40 disabled:cursor-not-allowed focus:border-gray-500 focus:ring-gray-500/20'}
            className={` ${activeButton === 'Live' || activeButton === 'Pending' ? 'opacity-50 cursor-not-allowed' : ''}`}
          />
        </div>
      </div>
